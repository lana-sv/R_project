#Project 04 - Fraud Detection dataset

# https://www.kaggle.com/code/gpreda/credit-card-fraud-detection-with-rf-auc-0-93/data
...
data <- data.table::fread("creditcard.csv")
