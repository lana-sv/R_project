#Project 06 - Recommendation Netflix Prize project:
...
#setwd("/Users/lana/Desktop/Movie recommendation - R/IMDB-Dataset")
movie_data <- read.csv("movies.csv",stringsAsFactors=FALSE) #27278 obs of 3 var
rating_data <- read.csv("ratings.csv")   #1048575 obs of 4 var
str(movie_data)
...
# the similarity that is shared between the films:
